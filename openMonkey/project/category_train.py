...
def get_single_json(file, species, bbox, landmarks, visibility):
    new_json = {"file":file,
                "species":species,
                "bbox":bbox,
                "landmarks":landmarks,
...
def main():
    filepath = "./train_annotation.json"
    export_new_path = "./train_new_monkey.json"
    export_old_path = "./train_old_monkey.json"
    export_ape_path = "./train_ape.json"
    export_new = {}
    export_old = {}
    export_ape = {}
    export_new["data"] = []
    ...
    for index in range(len_data):
        ...
        if species == "Emperor_tamarin" or species == "Golden_lion_tamarin" or species == "Tufted_capuchin" or species == "Common_marmoset" or species == "Cotton-top_tamarin" or species == "Squirrel_monkey" or species == "":
            new_json = get_single_json(file, species, bbox, landmarks, visibility)
